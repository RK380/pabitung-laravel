                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <select class="form-select" id="jenis" name="jenis" aria-label="Default select example" required>
                                            ...
                                            <option value="Gugatan Sederhana" @selected(old('jenis') == 'Gugatan Sederhana')>Gugatan Sederhana</option>
                                            <option value="Isbat Gugatan" @selected(old('jenis') == 'Isbat Gugatan')>Isbat Gugatan</option>
                                    </select>
