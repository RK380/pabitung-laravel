                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table id="myDataTable" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th class="text-nowrap text-center"><Aksi class="fas fa-cog"></i></th>
                                        ...
                                        <tr>
                                            <td class="text-nowrap">
                                                ...
                                                <span class="badge {{ $badge }}">{{ $status }}
                                                    @if(!empty($keterangan))
                                                            <h6 style="font-color:#FFFFFF;padding-top:5px;">
                                                                ⏳ {{ $keterangan }}
                                                            </h6>
                                                    @endif
                                                </span>
                                            ...
                                            <td class="text-nowrap"><span class="badge bg-secondary">{{ $row->noperkara }}</td>
