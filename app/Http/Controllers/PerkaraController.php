    ...
    public function store(StorePerkaraRequest $request)
    {
        try {
            Perkara::create([
                ...
                'tergugatii' => $request->tergugatii,
                'tergugatiii' => $request->tergugatiii,
                'tergugativ' => $request->tergugativ,
                ...
                'email_tergugatii' => $request->emailtergugatii ?? null,
                'email_tergugatiii' => $request->emailtergugatiii ?? null,
                'email_tergugativ' => $request->emailtergugativ ?? null,
